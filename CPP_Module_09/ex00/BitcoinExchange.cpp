...
void    BitcoinExchange::validatePrice(double price, bool flag) {
    if (price < 0)
        throw NotPosNumberException();
    if (flag && 1000 < price)
        throw TooLargePriceException();
}
...
const char * BitcoinExchange::TooLargePriceException::what() const throw()
{
